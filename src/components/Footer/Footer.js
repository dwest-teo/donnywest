...
const Footer = () => (
  <footer className="pa3 ph5-ns pv4-ns b--black-10 black-70">
    ...
    <a
      className="link b f3 f2-ns dim db gray lh-solid mb3"
      href="mailto:hello@donnywest.com"
    >
      hello@donnywest.com
    </a>
    <a
    ...
    <a
      ...
      target="_blank"
    >
      <svg data-icon="dribbble" viewBox="0 0 16 16" style={{ fill: 'currentcolor' }}>
    ...
    <p className="f6 db b ttu lh-solid mb0">© 2016 Donny West</p>
  </footer>
);
